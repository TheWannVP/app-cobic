  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: Colors[colorScheme ?? 'light'].background }]} edges={['top']}>
      ...
      >
        ...
        ) : miningStatus && miningStats ? (
          <>
            <ThemedView style={styles.statsCard}>
              <View style={styles.statsHeader}>
                <Ionicons name="stats-chart" size={24} color={Colors[colorScheme ?? 'light'].tint} />
                <ThemedText style={styles.statsTitle}>Thống kê Mining</ThemedText>
              </View>
              <View style={styles.statsContent}>
                <View style={styles.statsRow}>
                  <View style={styles.statsLabel}>
                    <Ionicons name="wallet" size={16} color={Colors[colorScheme ?? 'light'].text} />
                    <ThemedText style={styles.statsLabelText}>Tổng số đã mining</ThemedText>
                  </View>
                  <ThemedText style={styles.statsValue}>{miningStats.totalMined} COBIC</ThemedText>
                </View>
                <View style={styles.statsRow}>
                  <View style={styles.statsLabel}>
                    <Ionicons name="speedometer" size={16} color={Colors[colorScheme ?? 'light'].text} />
                    <ThemedText style={styles.statsLabelText}>Tốc độ mining</ThemedText>
                  </View>
                  <ThemedText style={styles.statsValue}>{miningStats.miningRate}</ThemedText>
                </View>
                <View style={styles.statsRow}>
                  <View style={styles.statsLabel}>
                    <Ionicons name="repeat" size={16} color={Colors[colorScheme ?? 'light'].text} />
                    <ThemedText style={styles.statsLabelText}>Số lần mining</ThemedText>
                  </View>
                  <ThemedText style={styles.statsValue}>{miningStats.miningCount}</ThemedText>
                </View>
                <View style={styles.statsRow}>
                  <View style={styles.statsLabel}>
                    <Ionicons name="calendar" size={16} color={Colors[colorScheme ?? 'light'].text} />
                    <ThemedText style={styles.statsLabelText}>Lần mining đầu tiên</ThemedText>
                  </View>
                  <ThemedText style={styles.statsValue}>{formatTime(miningStats.firstMiningTime)}</ThemedText>
                </View>
                <View style={styles.statsRow}>
                  <View style={styles.statsLabel}>
                    <Ionicons name="time" size={16} color={Colors[colorScheme ?? 'light'].text} />
                    <ThemedText style={styles.statsLabelText}>Lần mining cuối</ThemedText>
                  </View>
                  <ThemedText style={styles.statsValue}>{formatTime(miningStats.lastMiningTime)}</ThemedText>
                </View>
              </View>
            </ThemedView>
            ...
            <ThemedView style={styles.infoCard}>
              <View style={styles.infoHeader}>
                ...
                <ThemedText style={styles.infoTitle}>Thông tin Mining</ThemedText>
              </View>
              <View style={styles.infoContent}>
                <View style={styles.infoRow}>
                  <View style={styles.infoLabel}>
                    <Ionicons name="rocket" size={16} color={Colors[colorScheme ?? 'light'].text} />
                    <ThemedText style={styles.infoLabelText}>Tốc độ mining</ThemedText>
                  </View>
                ...
                <View style={styles.infoRow}>
                  <View style={styles.infoLabel}>
                    ...
                    <ThemedText style={styles.infoLabelText}>Tốc độ cơ bản</ThemedText>
                  </View>
                ...
                <View style={styles.infoRow}>
                  <View style={styles.infoLabel}>
                    ...
                    <ThemedText style={styles.infoLabelText}>Tốc độ của bạn</ThemedText>
                  </View>
