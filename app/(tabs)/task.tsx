        ...
        {loading ? (
          <View style={styles.loadingContainer}>
            <View style={styles.loadingIconContainer}>
              <Ionicons name="reload" size={32} color={Colors[colorScheme ?? 'light'].tint} />
            </View>
            <ThemedText style={styles.loadingText}>Đang tải nhiệm vụ...</ThemedText>
          </View>
        ) : tasks.length > 0 ? (
          tasks.map((task) => (
          ...
          <View style={styles.emptyContainer}>
            <View style={styles.emptyIconContainer}>
              <Ionicons name="alert-circle" size={64} color={Colors[colorScheme ?? 'light'].text} />
            </View>
